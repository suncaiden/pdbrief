...
The strongest design is the {{randomised controlled trial}}: assign people to treatment or placebo purely by chance, so the groups are otherwise comparable.
...
{{blinding|Double-blind}} means neither side knows. It is the standard for good reason.
...
{{statistical significance|Statistically significant}} does not mean large. With enough participants, a difference far too small to notice will still clear the significance threshold.
